...
export default function ChatItem({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }) {
    ...
    return <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full" >
        <div className="group flex gap-x-2 items-start w-full" >
            ...
            <div className="flex flex-col w-full">
                ...
                {!fileUrl && !isEditing && (
                    <p className={`text-sm text-zinc-600 dark:text-zinc-400 ${deleted && "italic text-zinc-500 dark:text-zinc-400 text-xs mt-1"}`} >
                        {content}
                        {isUpdated && !deleted && (
                                    ...
                                    <FormItem className="flex-1">
                                        <FormControl>
                                            <div className="relative w-full">
                                                <Input
                                                    disabled={isLoading}
                                                    className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-nonoe border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
